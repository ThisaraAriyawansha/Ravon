...
import { UserGroupIcon, AppStoreIcon, RocketLaunchIcon, ChartBarIcon } from '@heroicons/react/24/outline'
...
const HomePage = () => {
  return (
    <div >
      ...
      <div className="mb-16 bg-transparent p-28">
  <div className="flex flex-col items-center max-w-6xl mx-auto md:flex-row">
    ...
    >
      <h1 className="mb-8 text-4xl font-bold leading-snug text-gray-800 ">
        Top Mobile App Development Company in Sri Lanka.
      </h1>
      <p className="mt-4 mb-10 text-gray-600">
        Reevan solves the world's biggest problems with expertise. Reevan helps<br/>
        global brands with digital products on web, mobile, and connected<br/>
        platforms.
      </p>

      {/* Stats Section */}
      <motion.div
        className="flex justify-between mt-6 mb-10 space-x-4"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        {/* Card 1 - People Icon */}
        <motion.div
          className="flex items-center w-48 p-3 space-x-2 transition-all duration-300 transform rounded-lg shadow-md bg-gradient-to-r from-blue-100 to-blue-50 hover:shadow-lg hover:scale-105"
        ...
        <motion.div
          className="flex items-center w-48 p-3 space-x-2 transition-all duration-300 transform rounded-lg shadow-md bg-gradient-to-r from-orange-100 to-orange-50 hover:shadow-lg hover:scale-105"
          whileHover={{ scale: 1.1 }}
        >
        ...
        {/* Card 3 - Rocket Icon */}
        <motion.div
          className="flex items-center w-48 p-3 space-x-2 transition-all duration-300 transform rounded-lg shadow-md bg-gradient-to-r from-green-100 to-green-50 hover:shadow-lg hover:scale-105"
          whileHover={{ scale: 1.1 }}
        >
      ...
      >
        <button className="flex items-center justify-center px-6 py-2 mr-10 text-white rounded-full bg-gradient-to-r from-green-800 to-green-600 hover:from-green-900 hover:to-green-700">
          Talk to Our Expert
